                ...
                <Router history={history}>
                    ...
                    <div className="dashboard">
                        <div className="left-navigator">
                            <div className="user-profile">
                                ...
                                <div className="user-info">
                                    <h6 className="user-fullname">{localStorage.getItem('user-email')}</h6>
                                    <p className="user-position">{localStorage.getItem('user-type')}</p>
                                </div>
                            </div>
                            <ul className="selector-buttons">
                                ...
                                <li style={{ cursor: 'pointer' }}>
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path fillRule="evenodd" clipRule="evenodd" d="M15.1801 2.19H9.02006L7.54006 3.66L6.13006 2.25L8.19006 0.190002H15.1801C16.2801 0.190002 17.1801 1.09 17.1801 2.19V13.3L15.1801 11.3V2.19ZM19.4401 18.4L1.97006 0.930002L0.560059 2.34L3.30006 5.08L3.18006 5.2V16.19C3.18006 17.29 4.08006 18.19 5.18006 18.19H15.1801C15.5301 18.19 15.8601 18.09 16.1501 17.93L18.0301 19.81L19.4401 18.4ZM5.18006 16.19V6.96L14.4101 16.19H5.18006Z" fill="#66788A" />
                                    </svg>
                                    <p>Absences</p>
                                </li>
                                <li style={{ cursor: 'pointer' }}>
                                ...
                                <li style={{ cursor: 'pointer' }}>
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path fillRule="evenodd" clipRule="evenodd" d="M2 0H18C19.1 0 20 0.9 20 2V14C20 15.1 19.1 16 18 16H4L0 20L0.01 2C0.01 0.9 0.9 0 2 0ZM3.17 14H18V2H2V15.17L2.58 14.59L3.17 14ZM4 10H6V12H4V10ZM6 7H4V9H6V7ZM4 4H6V6H4V4ZM13 10H8V12H13V10ZM8 7H16V9H8V7ZM16 4H8V6H16V4Z" fill="#66788A" />
                                    </svg>
                        ...
                        <div className="right-main-content">
                            <Route exact path="/students" component={() => <StudentsList students={this.props.students} setStudents={this.props.setStudents} />}></Route>
                            <Route exact path="/teachers" component={() => <TeachersList teachers={this.props.teachers} setTeachers={this.props.setTeachers} />}></Route>
                            <Route exact path="/timetable" component={() => <Timetable weekdays={this.props.weekdays} setTimeTableData={this.props.setTimeTableData} />}></Route>
                            ...
                            <Route exact path="/addUniversity" component={AddUniveristy}></Route>
                        </div>
                    </div>
                </Router>
            );
        ...
        <div>
            ...
            <div className="list-container">
                <table className="teachers-table">
                    ...
                    <tbody>
                        <tr>
                            <td className="table-fullname">Rabih Amhaz</td>
                            <td>Computer Science</td>
                            <td>Computer Science</td>
                        </tr>
                        <tr>
                            <td className="table-fullname">Javad Alizada</td>
                            <td>Chemical Engineering</td>
                            <td>Chemical Engineering</td>
                        </tr>
                        <tr>
                            <td className="table-fullname">Pierre Collet</td>
                            <td>Computer Science</td>
                            <td>Computer Science</td>
                        </tr>
        ...
        <div>
            ...
            <div className="list-container">
                <table className="students-table">
                    ...
                    <tbody>
                        <tr>
                            <td className="table-fullname">Rashad Aliyev</td>
                        ...
                        <tr>
                            <td className="table-fullname">Ofelia Rahmanova</td>
                            <td>Computer Science</td>
                            <td>2017</td>
                            <td>Good</td>
                            <td>5%</td>
                        ...
                        <tr>
                            <td className="table-fullname">Muhammad Samadzade</td>
                            <td>Computer Science</td>
                            <td>2017</td>
                            <td>Good</td>
                            <td>2%</td>
                        ...
                        <tr>
                            <td className="table-fullname">Mirzemehdi Karimov</td>
                            <td>Computer Science</td>
                            <td>2017</td>
                            <td>Good</td>
                            <td>15%</td>
                        ...
                        <tr>
                            <td className="table-fullname">Nigar Yusifzada</td>
                            <td>Computer Science</td>
                            <td>2017</td>
                            <td>Good</td>
                            <td>7%</td>
...
const addStudentHandler = e => {
    ...
    const data = {
        ...
        enrolledLessons: this.enrolledLessons
    }
    ...
    return (
        <div className="add-user">
            ...
            <div className="dashboard-card-item">
                ...
                <form className="dashboard-card-inner" onSubmit={addStudentHandler}>
                    <div className="dashboard-form col-md-12">
                        <div className="dashboard-form-col col-md-4">
                            <input type="text" name="firstname" placeholder="First name" onChange={e => this.firstname = e.target.value} required />
                            <input type="email" name="email" placeholder="Email" onChange={e => this.email = e.target.value} required />
