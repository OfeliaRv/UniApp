...
import AddUniveristy from '../components/AddUniversity';
            ...
            <Router history={history}>
                ...
                <div className="dashboard">
                    ...
                    <div className="right-main-content">
                        ...
                        <Route exact path="/addTeacher" component={() => <AddTeacher addTeacherHandler={addTeacherHandler} />}></Route>
                        <Route exact path="/addStudent" component={() => <AddStudent addStudentHandler={addStudentHandler} />}></Route>
                        {/* <Route exact path="/user" component={User}></Route> */}
                        <Route exact path="/addUniversity" component={() => <AddUniveristy addUniversityHandler={addUniversityHandler} />}></Route>
                    </div>
                </div>
            </Router>
        );
...
const addTeacherHandler = e => {
    ...
    axios.post(`/administrator/createTeachers`, data)
        .then(res => {
            console.log(res);
